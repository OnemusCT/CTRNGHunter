...
// Chrono Trigger's hardcoded 256-entry RNG lookup table.
int rng_table(int i) {
    static constexpr std::array<uint8_t, 256> table = { 0xB1, 0xCA, 0xEE, 0x6C, 0x5A, 0x71, 0x2E, 0x55, 0xD6, 0x00, 0xCC, 0x99, 0x90, 0x6B, 0x7D, 0xEB,
