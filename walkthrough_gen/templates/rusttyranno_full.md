...
**2nd option** when Magus turns back and hear battle sound (textbox after "Pig\!"), go down  
Name Magus (Down, Confirm, Up, Confirm)

**Menu**  
Party (Lucca / Magus / Marle)
...
Back to Epoch, cutscenes  
Press Warp after dialogue after middle ages scene  
Go to Middle Ages (Up)

### Choras Village

Fly straight down  
Enter Tavern (right) and talk to first guy (up+right)  
Back to Epoch and go to the End of Time (Up x4)

### End of Time

**2nd option** to Get off  
Talk to Old Man, interact with top-right bucket and talk again  
**Get Chrono Trigger**  
Board Epoch and go to Present (Down x3)

### Lucca's House

Fly to Lucca's House (up+left) and talk to Taban  
**Get Taban's Suit** and **Taban's Helm**

### Porre Village

Fly south and enter Snail Stop (right)  
**Buy Jerky**

### Choras Village

Fly right and a little bit up and enter West Cape  
**Pick Speed Capsule** (behind Toma's Grave)

Fly to Choras Inn (right) and talk to the guy drinking (5 textboxes)  
Go out, enter Residence (south) and talk to his wife  
**Get Carpenter's Tools**

Board Epoch and go to the Middle Ages (Down)

Enter Tavern (right) and deliver tools to first guy  
Go out, enter Residence (south) and talk to him

### Northern Ruins

Walk instead of Epoch on first ruins visit  
Go through the left door

* Mid-Ether if MP Buster on first two fights  
* Hi-Potion if low HP  
...
Party (Frog / Lucca / Robo)

* Magus <-> Frog  
* Frog <-> Lucca  
* Marle <-> Robo

Go to residence and talk to carpenter again  
Fly back to ruins

Go left, **pick Turbo Ether** (optional) and continue to Cyrus grave  
Watch cutscenes and go out
...
**Pick Hi-Ether** (take damage from guillotine)  
...
Go left of torch to avoid encounter, enter open mouth  
Step on right switch
...
If didn't steal Red Plate, go left and up three floors for Red Vest  
Go out
