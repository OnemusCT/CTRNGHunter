...
class RNGSimImpl : public RNGSim {
    public:
        ...
        bool battle_with_crits(std::vector<int> threshold, int min_crits, int max_turns, std::string_view name,
...
bool RNGSimImpl::battle_with_crits(std::vector<int> threshold, int min_crits, int max_turns, std::string_view name,
                                   LogLevel log_level) {
    last_steps = 1;
    int crits = 0;
    int r = rng_.rand();
